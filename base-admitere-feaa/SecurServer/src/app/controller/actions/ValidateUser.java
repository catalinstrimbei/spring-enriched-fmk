 ...
 * @author catalin
 */
public class ValidateUser extends AppAction{
    private Logger logger = Logger.getLogger(this.getClass().getName());

    public ValidateUser(String name, SecurityService service) {
        super(name);
    ...
    public IApplicationEvent actionPerformed(IApplicationEvent event) {
        ...
        try{
            event.setValue("user", service.forceRevalidateUser((AppUser)event.getValue("user")));
        } catch(Exception e){
