 ...
 * @author catalin
 */
public class LoadRoleUsers extends AppAction{
    private Logger logger = Logger.getLogger(this.getClass().getName());

    public LoadRoleUsers(String name, SecurityService service) {
        super(name);
    ...
    public IApplicationEvent actionPerformed(IApplicationEvent event) {
        ...
        event.setValue("users", service.getRoleUsers((AppRole)event.getValue("role")));
        return event;
    }
}
