 ...
 * @author catalin
 */
public class CreateNewUser extends AppAction{
    private Logger logger = Logger.getLogger(this.getClass().getName());

    public CreateNewUser(String name, SecurityService service) {
        super(name);
    ...
    public IApplicationEvent actionPerformed(IApplicationEvent event){
        ...
        try {
            event.setValue("user", service.addUserInApp((AppUser)event.getValue("user")));
        } catch(Exception e){
