 ...
 * @author catalin
 */
public class ResetUserPassword extends AppAction{
    private Logger logger = Logger.getLogger(this.getClass().getName());

    public ResetUserPassword(String name, SecurityService service) {
        super(name);
    ...
    public IApplicationEvent actionPerformed(IApplicationEvent event) {
        ...
        try{
            event.setValue("user", service.forceRevalidateUserPassword((AppUser)event.getValue("user")));
        } catch(Exception e){
