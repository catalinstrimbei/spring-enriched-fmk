 ...
 * @author catalin
 */
public class NumericRangeValidation extends AbstractNumericValidationRule {

    private String message = "trebuie sa fie in intervalul";
...
//                    propertyValue.getClass());
        ...
        if (propertyValue != null) {
            ...
            System.out.println("Check " + minvalArgument + ".." + maxvalArgument +
                    " value interval for " + propertyName + " = "+ propertyValue);
            
            if (this.compare(propertyValue, minvalArgument) == -1) {
                String customMessage = "Valoarea " + propertyName + " " + message +
                        minvalArgument + ".." + maxvalArgument+ " !";
